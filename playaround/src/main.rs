...
fn main() {
    ...
    // println!("is_zero_remainder is {}", is_zero_reminder);
    ...
    // Strings and Basic Collections
    // let name: &str = "Robert";
    // println!("name is {:?}", name);

    // let dynamic_name: String = String::from("Robert Rouse");
    // println!("dyname_name is {}", dynamic_name);
    // println!("the dynamic_name is stored in memory at {:p}", &dynamic_name);
