...
impl Shape for Circle {
    fn area(&self) -> f32 {
        let area_of_circle = self.radius * self.radius * 3.14159;
        println!("Circle area: {}", area_of_circle);
        area_of_circle
    }

    fn perimeter(&self) -> f32 {
        let perimeter_of_circle = 2.0 * self.radius * 3.14159;
        println!("Circle Perimeter or Circumfernce: {}", perimeter_of_circle);
        perimeter_of_circle
    }
}
